...
import type { BrandKit, Campaign } from "@/lib/campaignforge-api";
...
export function CampaignWorkspace({ campaign, brandKits }: { campaign: Campaign; brandKits: BrandKit[] }) {
